import {  sc_type_const, sc_type_dedge_common,sc_type_edge_access, sc_type_edge_fuz, sc_type_edge_neg, sc_type_edge_perm, sc_type_edge_pos, sc_type_edge_temp, sc_type_link, sc_type_node, sc_type_node_abstract, sc_type_node_class, sc_type_node_material, sc_type_node_norole, sc_type_node_role, sc_type_node_struct, sc_type_node_struct_mask, sc_type_node_tuple, sc_type_uedge_common, sc_type_var } from "ts-sc-client";
var SCg = SCg || {
    version: "0.1.0"
};
...
const typesMap = {
    ...
    'scg-type-edge-common': sc_type_uedge_common,
    'scg-type-arc-common': sc_type_dedge_common,
    'scg-type-arc-common-access': sc_type_edge_access,
    'scg-type-edge-const': sc_type_uedge_common | sc_type_const,
    'scg-type-arc-const': sc_type_dedge_common | sc_type_const,
    'scg-type-arc-const-perm-pos-access': sc_type_edge_access | sc_type_const | sc_type_edge_pos |
        sc_type_edge_perm,
    'scg-type-arc-const-perm-neg-access': sc_type_edge_access | sc_type_const | sc_type_edge_neg |
        sc_type_edge_perm,
    'scg-type-arc-const-perm-fuz-access': sc_type_edge_access | sc_type_const | sc_type_edge_fuz |
        sc_type_edge_perm,
    'scg-type-arc-const-temp-pos-access': sc_type_edge_access | sc_type_const | sc_type_edge_pos |
        sc_type_edge_temp,
    'scg-type-arc-const-temp-neg-access': sc_type_edge_access | sc_type_const | sc_type_edge_neg |
        sc_type_edge_temp,
    'scg-type-arc-const-temp-fuz-access': sc_type_edge_access | sc_type_const | sc_type_edge_fuz |
        sc_type_edge_temp,
    'scg-type-edge-var': sc_type_uedge_common | sc_type_var,
    'scg-type-arc-var': sc_type_dedge_common | sc_type_var,
    'scg-type-arc-var-perm-pos-access': sc_type_edge_access | sc_type_var | sc_type_edge_pos |
        sc_type_edge_perm,
    'scg-type-arc-var-perm-neg-access': sc_type_edge_access | sc_type_var | sc_type_edge_neg |
        sc_type_edge_perm,
    'scg-type-arc-var-perm-fuz-access': sc_type_edge_access | sc_type_var | sc_type_edge_fuz |
        sc_type_edge_perm,
    'scg-type-arc-var-temp-pos-access': sc_type_edge_access | sc_type_var | sc_type_edge_pos |
        sc_type_edge_temp,
    'scg-type-arc-var-temp-neg-access': sc_type_edge_access | sc_type_var | sc_type_edge_neg |
        sc_type_edge_temp,
    'scg-type-arc-var-temp-fuz-access': sc_type_edge_access | sc_type_var | sc_type_edge_fuz |
        sc_type_edge_temp,
